...
const features = [
    { icon: FaTag, title: '공항 대비 50% 절약', desc: '공항 내 주차장 1일 10,000원, 저희는 1시간 500원, 1일 최대 5,000원(0시 이후 초기화됩니다.)! 동일한 서비스, 절반의 비용으로 스마트한 절약을 경험하세요.' },
        ...
        <div className="animate-fade-in py-8 space-y-10">
            ...
            <div className="text-center space-y-3">
                ...
                <p className="text-slate-500 text-base">
                    주차난 걱정 끝! 1시간 500원, 1일 최대 5,000원(0시 이후 초기화됩니다.)으로 즐기는 스마트한 여행의 시작<br />
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm ring-1 ring-slate-100 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    {[
                        { label: '이용 요금', value: '1시간 500원, 1일 최대 5,000원 (0시 이후 초기화됩니다. / 출차 시 차단기 아이파킹 결제)' },
